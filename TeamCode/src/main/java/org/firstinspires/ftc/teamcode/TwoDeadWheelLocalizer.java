...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1728.315288192426; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -3089.19760491097; // x position of the perpendicular encoder (in tick units)
    }
    ...
    public TwoDeadWheelLocalizer(HardwareMap hardwareMap, IMU imu, double inPerTick, Pose2d initialPose) {
        ...
        perp = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, "left_climber")));
        par = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, "right_climber")));
