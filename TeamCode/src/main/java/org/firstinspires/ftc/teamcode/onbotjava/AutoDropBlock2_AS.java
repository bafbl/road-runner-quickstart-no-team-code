...
public class AutoDropBlock2_AS extends LinearOpMode
{
    ...
    public void runOpMode()
    {
        ...
        long start_t=System.currentTimeMillis();
            ...
            robot.teamDriveTrain.moveToPosition(0.35,pose4);
            robot.sleep(500);
            ...
            robot.teamDriveTrain.moveToPosition(0.35,pose2);
            robot.sleep(2500);
            ...
            robot.teamDriveTrain.moveToPosition(0.5,pose7);
            ...
            robot.arm.intakeServo.setPower(1.0);
            robot.arm.backIntakeServo.setPower(-1);
            robot.teamDriveTrain.moveToPosition(0.35,pose8);
            robot.sleep(600);
            while (robot.arm.intakeMotorAS.getCurrentPosition()<-50){
                robot.arm.intakeMotorAS.setPower(1);
            }
